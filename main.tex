...
One form makes the four concrete. For \mention{gee} in present-day English, the
declaration is that observing prosodic separation and morphological bareness
predicts supplement function, use-conditional meaning, and availability
turn-initially. The warrant is the set of links in Table~\ref{tab:link-status},
and it would be defeated if \mention{gee} began taking complements or
inflecting. The profile is that combination, which recurs across \mention{wow},
\mention{ouch}, and \mention{hey} and has recurred over time; network order is
the further claim that prosodic isolation makes syntactic non-integration more
available rather than merely accompanying it. The ground is euphemistic
bleaching from a religious invocation, which put \mention{gee} in the cluster.
Whether anything holds it there is a separate question, and nothing below shows
the combination being restored after disturbance.

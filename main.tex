...
\item The profile is the relation the declaration posits, and its stability is
  the separate observation that the same combination recurs across forms and
  over time. Network order is a further and independent claim, that the
  properties are linked rather than merely co-occurring.
...
Corrective control is what \term{homeostasis} asks for. I don't claim it.
Projectibility needs the declaration warranted and the profile stable; it
doesn't need a corrective process, and nothing below identifies one.

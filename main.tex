...
projectibility: a form's membership in the category supports
...
category supports inference to: likely prosody, syntactic independence,
limits on argumenthood, stance or response function, and possible pathways
...
\term{projection target}: what an analyst may infer from a form's
categorization as an interjection, and what speakers and hearers may
anticipate from partial cues without categorizing at all. It then asks whether a

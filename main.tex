...
syntactic residue discussed in Section~\ref{sec:syntax}.
\textcite[40]{cuenca2002} reads it the same way from the grammaticalization
side, listing \mention{Goddammit} as a case where change in function and
meaning is \enquote{accompanied by phonetic weakness and word integration}. None of these

...
**Status:** **REJECTED by *Journal of Pragmatics* 2026-07-23** (PRAGMA-D-26-00584; blanket citation-integrity policy, no revised version accepted). See `notes/2026-07-23-jop-rejection-citation-integrity.md`. **Quote audit completed 2026-07-24** (`notes/2026-07-24-quote-audit.md`): of nine checkable quotations, one was clean; eight fixes applied. Of 14 source quotations, 13 are now verified; only Libert 2019 is unchecked.
...
3. **Audit essentially closed 2026-07-24.** Second and third passes verified everything except one item. Wilkins 1992: 142 is **verified** from Brett's own copy in `~/Downloads` and was not a fabrication (my suspicion was wrong); Wilkins 1992: 124 is now verified directly rather than through Gehweiler, which also corrected an inherited transcription error ("constructions" -> Wilkins's singular "construction"). Bullokar, H&P 2005 and Coulmas all verified. **One quotation remains unchecked: Libert 2019** at l. 248, an *Oxford Bibliographies in Linguistics* annotated-bibliography entry (doi 10.1093/obo/9780199772810-0230); the file of that name in `~/Downloads` is a different paper (Sheehan et al. in *Communication Research*). Also outstanding: page checks for Bullokar p. 373 (Turner 1980 pagination) and H&P 2005 p. 16.
4. **The SIEG2 fix (new, highest-value remaining edit).** The intro says H&P "dropped it from the textbook", true of the 2005 first edition but **false of the second edition, which Brett co-authored**: SIEG2 (978-1-316-51464-1) lists interjection among its lexical categories, sets exercises on it, and treats it as a supplement category, saying only (p. 24) "Grammarians typically say very little about interjections, and we don't plan to be an exception." Cite both editions. A *Journal of Linguistics* reviewer is likely to hold SIEG2. Source material is in `~/Documents/CGEL/` (SIEG2 manuscript, errata, drafting chapters) — a directory no previous session had searched.

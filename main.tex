...
\footnote{Part-of-speech--tagged frequencies in COHA \citep{davies2010},
  ...
  \texttt{interjection-lemmas-coha-by-decade.csv}. Rankings are among the
  twenty most frequent interjection lemmas across the corpus as a whole, so a
  form frequent only in the earliest decades could in principle sit outside
  them.

...
% VERIFY BEFORE SUBMISSION: this Wilkins wording is verified verbatim from
% Gehweiler (2008: 73), who block-quotes it with the page. Check against
% Wilkins 1992: 124 directly when a copy is available; if the relay has to
% stand, change to "quoted in \textcite[73]{gehweiler2008}".
...
constructions with other word classes, is (usually) monomorphemic, and
...
point of view of} another} \citep[160]{boyd1999}. The present paper
...
\footnote{The interrogative/question contrast uses different words for
  ...
  The Latin
  \term{ejaculatio}, a throwing out, mirroring \term{interjectio},
  a throwing between, would have been etymologically perfect

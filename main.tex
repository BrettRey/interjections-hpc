...
explain how the form got there and why it stays. \textcite{oed_oof} derives
\mention{oof} as an imitative formation, which puts its entry on the
onomatopoeic route of Section~\ref{sec:recruitment} rather than on either
bleaching path. A stabilizer would be whatever keeps the combination
...
\textcite{boyd1999}, developing \term{homeostatic-property-cluster theory},
showed that categories with no definitional necessary and sufficient conditions
can be useful and projectible when their properties are connected
non-accidentally. The question is how strong a causal claim the
co-occurrence documented in Section~\ref{sec:cluster} supports.

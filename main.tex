...
% House style maps BoldFont to the regular face, so \textbf is a no-op
% document-wide. Inside an italic example the working contrast is upright
% roman, which is also Bringhurst's device for emphasis within italic.
\newcommand{\exfocus}[1]{\textup{#1}}

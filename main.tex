...
items are restricted to the interjection tag, so they exclude other uses of the
same string. Counts for \mention{haba} and \mention{yaar} cannot be, because
...
where the core figures are filtered, which inflates the regional items relative
to the items they are set beside. The size of that inflation is indicated by

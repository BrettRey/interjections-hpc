...
4. **One intro pass outstanding — the highest-value remaining edit, and the last thing blocking submission anywhere.** Two problems found while chasing sources, both in the opening, both argumentative rather than integrity matters:
   - **SIEG2 currency.** "Dropped it from the textbook" / "thin enough for the textbook to cut" is true of the 2005 first edition and **false of the second, which Brett co-authored**: SIEG2 (978-1-316-51464-1) lists interjection among its lexical categories, sets tagging exercises on it, treats it as a supplement category, and says only (p. 24) "Grammarians typically say very little about interjections, and we don't plan to be an exception." Cite both editions. Source material in `~/Documents/CGEL/`.
   - **Libert neglect.** The paper quotes Libert's morphology-gap sentence from a paragraph whose point is that "to say that they have been neglected, as some authors do, is an overstatement." The intro leans on the neglect framing, and Ameka's cited title is "The Universal Yet Neglected Part of Speech." A reviewer following the citation lands on the rebuttal one clause from the borrowed words.
   Both fixes point the same way and strengthen the paper: the defensible premise is denial of **category status** (Jespersen, Quirk, H&P 2005) plus an undescribed morphology, not general neglect. That survives Libert's objection and fits the lexical-category reframe better than the neglect story does.

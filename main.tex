...
I treat that use as recent, which is what makes it useful here.
...
family. The warrant is whatever supports that expectation, and for a form
this recent it is thin: analogy to \mention{ouch} and \mention{wow}, and the
links set out below. The profile is the relation the declaration posits, and

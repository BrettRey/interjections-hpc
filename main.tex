...
claim Section~\ref{sec:proj-pragmatic} makes good.
...
\term{interjection\textsubscript{int}}, and he credits
...
Intj\textsubscript{int} if it is usable on its own as an interactional move, which is the sequential-use column read as a field-relative classification.
...
under repetition would defeat the prediction. \term{interjection\textsubscript{int}}
...
\subsection{Why the projectibility is pragmatic}\label{sec:proj-pragmatic}
...
morphosyntactically: \mention{lecturer} takes a determiner, inflects for
number, and fills an argument slot. Categorizing something as a noun tells you almost
...
From \term{interjection\textsubscript{int}} you get a turn position,

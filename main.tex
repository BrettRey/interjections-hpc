...
universals. That shape isn't peculiar to interjections. It's what a lexical
category looks like when no definition is holding it together. The tradition
...
The form isn't new. \textcite{oed_oof} records it from 1777 and derives it as an
imitative formation, which puts it on the onomatopoeic route of
Section~\ref{sec:recruitment} rather than on either bleaching path. What is
recent is its prominence: COHA has three tokens before 1900, then a rise from
...
to resist determiners and to carry stance rather than reference, in
present-day English, in its standalone use rather than across the whole word
family. The warrant is whatever supports that expectation, and here it is
...
The residue claim isn't only mine. \textcite[40]{cuenca2002} observes that
...
verb-to-interjection paths. Take \mention{bruh}. The word family isn't
new. \textcite{oed_bruh} records it as a noun from 1894, as a title before a
man's name, and from 1967 as a familiar form of address, where every quotation
is vocative (\mention{Hey, bruh}, \mention{Be cool, bruh}). What is new is the
standalone use addressed to nobody, which the entry doesn't record as an
interjection at all. Its rise shows up in COCA, from 0.01 per million in
...
The semantic node predicts meaning type: that it will convey stance rather than
describe. The interactional node predicts sequence: where in a turn the form

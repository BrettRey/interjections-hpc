...
\term{interjection\textsubscript{prag}}. The sections below first
...
between \term{interjection\textsubscript{sem}} and
\term{interjection\textsubscript{prag}}, and he credits
...
Intj\textsubscript{syn} if it functions as a supplement, taking no
complement and forming no constituent with neighbouring material;
Intj\textsubscript{sem} if its contribution is expressive and
use-conditional, leaving the truth conditions of its host untouched;
Intj\textsubscript{prag} if it is usable on its own as an interactional move, which is the sequential-use column read as a field-relative classification.
...
Intj\textsubscript{sem}, and Intj\textsubscript{prag} abbreviate
...
\textcite{potts2007}; \term{interjection\textsubscript{prag}} from
...
\toprule
 ...
 & \rotatebox{70}{Intj\textsubscript{prag}} \\
\midrule
\mention{gee!}
...
\item \term{interjection\textsubscript{prag}}, the interactional-pragmatic
  ...
  \term{interjection\textsubscript{prag}} but debatably
  \term{interjection\textsubscript{syn}}.
\end{itemize}
...
\term{interjection\textsubscript{prag}}.
...
Stabilizer candidate for \term{interjection\textsubscript{prag}} &
...
and uttering it performs the act. As \term{interjection\textsubscript{syn}},
...
for \term{interjection\textsubscript{prag}}. The fourth remains a
maintenance hypothesis.
...
\term{interjection\textsubscript{prag}}. If a novel form is recruited as a
...
\mention{mm-hm} a central \term{interjection\textsubscript{prag}} case.
...
\node[field] (intnode) at (9.5, 0.9) {Intj\textsubscript{prag}\\sequential use};
...
\term{interjection\textsubscript{prag}} would weaken before
...
\ea\label{ex:bruh}
  ...
  \ex \term{interjection\textsubscript{prag}}: the form should be available for
...
\item Cross-domain inferences (b, c): the
  \term{interjection\textsubscript{prag}} prediction (interactional-pragmatic
...
under repetition would defeat the prediction. \term{interjection\textsubscript{prag}}
...
and \term{interjection\textsubscript{prag}} (turn-initial, available for
...
\term{interjection\textsubscript{prag}} is weakened (it's not a backchannel or
...
\term{interjection\textsubscript{prag}}, the interactional-pragmatic
cluster.
...
asymmetry. From \term{interjection\textsubscript{syn}} you get what any
supplement gives you: prosodic isolation, no inflection, no argument structure.
From \term{interjection\textsubscript{prag}} you get a turn position,
...
\term{interjection\textsubscript{syn}} is thin next to those nodes, lacking
...
\begin{tabular}{lrr}
  ...
  \term{interjection\textsubscript{prag}} & 96.8\% & 0.90 \\
  \hline
\end{tabular}
\end{center}
...
\begin{tabular}{lrr}
  ...
  \term{interjection\textsubscript{prag}} & 1948 & 1939--1959 \\

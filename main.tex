...
is the kind of prediction each supports: the syntactic node supplies
distributional projectibility, the semantic node use-conditional and
expressive projectibility, and the interactional node sequential and
interactional projectibility.

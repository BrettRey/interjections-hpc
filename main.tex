...
is what a coupling link predicts and what a bare list of six properties
would leave as coincidence. A bare property list can't explain this
...
The paper's central claim concerns where the richest projectibility lies:
in stance expression, interactional-pragmatic distribution, and conversational
management rather than in truth-conditional denotation. The section first shows how partial
...
interactional pragmatics. As in Section~\ref{sec:intro}, bare \enquote{interjection}
...
decoupling: \mention{mm-hm} is \term{interjection\textsubscript{prag}} but

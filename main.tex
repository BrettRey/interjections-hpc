...
Wharton's continuum is worth noting for a second reason. He reaches graded
membership from relevance theory, by a route carrying no HPC commitments at
all, which is what Section~\ref{sec:boundaries} says should keep happening.
...
account reach the same explanation of why the gradient is there.
...
necessary and sufficient conditions, graded boundaries, and hedged

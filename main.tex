...
structured rather than accidental. Five properties emerge: prosodic isolation,
non-inflection, syntactic non-integration, non-referentiality, and emotive or
stance force. The three nodes cut across those five rather than regrouping them, because
...
is what a coupling link predicts and what a bare list of five properties
...
The last three columns are separate classifications, not sums of the first
five, so they need their own criteria. A construction is
...
Intj\textsubscript{int} if it is usable on its own as an interactional move.
...
\mention{the damn car}
  & \textendash{} & \checkmark & \textendash{} & \checkmark & \checkmark

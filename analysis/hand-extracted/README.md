...
| `hi-kwic-audit.md` | bare `hi` NG/GH | GloWbE | 40 tokens, 80% and 85% greeting. The regional contaminant is *hi life* for highlife, same shape as *hectare* but 1 in 20 not 8-11. Carries the summary table across all six items probed |
